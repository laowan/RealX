...
public class FileSource implements MediaSource {
    ...
    public MediaExtractor getVideoExtractor() throws IOException {
        MediaExtractor mediaExtractor = new MediaExtractor(MediaConst.MEDIA_EXTRACTOR_TYPE_VIDEO);
    ...
    public MediaExtractor getAudioExtractor() throws IOException {
        if(mAudioFile != null) {
            ...
            MediaExtractor mediaExtractor = new MediaExtractor(MediaConst.MEDIA_EXTRACTOR_TYPE_AUDIO);
