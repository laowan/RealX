...
public class Drawable2d {
    ...
    private static final FloatBuffer TRIANGLE_BUF =
            OpenGlUtils.createFloatBuffer(TRIANGLE_COORDS);
    private static final FloatBuffer TRIANGLE_TEX_BUF =
            OpenGlUtils.createFloatBuffer(TRIANGLE_TEX_COORDS);
    ...
    private static final FloatBuffer RECTANGLE_BUF =
            OpenGlUtils.createFloatBuffer(RECTANGLE_COORDS);
    private static final FloatBuffer RECTANGLE_TEX_BUF =
            OpenGlUtils.createFloatBuffer(RECTANGLE_TEX_COORDS);
    ...
    public static final FloatBuffer FULL_RECTANGLE_TEX_HORIZONTAL_FLIP_BUF =
            OpenGlUtils.createFloatBuffer(FULL_RECTANGLE_TEX_COORDS_FLIP_HORIZONTAL);
    public static final FloatBuffer FULL_RECTANGLE_TEX_VERTICAL_FLIP_BUF =
            OpenGlUtils.createFloatBuffer(FULL_RECTANGLE_TEX_COORDS_FLIP_VERTICAL);
     ...
     */
    public enum Prefab {
        TRIANGLE, RECTANGLE, FULL_RECTANGLE, FULL_RECTANGLE_FLIP_HORIZONTAL, FULL_RECTANGLE_FLIP_VERTICAL
    }
    ...
    public Drawable2d(Prefab shape) {
        switch (shape) {
            ...
            case FULL_RECTANGLE_FLIP_HORIZONTAL:
                mVertexArray = FULL_RECTANGLE_BUF;
                mTexCoordArray = OpenGlUtils.createFloatBuffer(FULL_RECTANGLE_TEX_COORDS_FLIP_HORIZONTAL);;
                mCoordsPerVertex = 2;
                mVertexStride = mCoordsPerVertex * SIZEOF_FLOAT;
                mVertexCount = FULL_RECTANGLE_COORDS.length / mCoordsPerVertex;
                break;
            case FULL_RECTANGLE_FLIP_VERTICAL:
                mVertexArray = FULL_RECTANGLE_BUF;
                mTexCoordArray = OpenGlUtils.createFloatBuffer(FULL_RECTANGLE_TEX_COORDS_FLIP_VERTICAL);;
                mCoordsPerVertex = 2;
                mVertexStride = mCoordsPerVertex * SIZEOF_FLOAT;
                mVertexCount = FULL_RECTANGLE_COORDS.length / mCoordsPerVertex;
                break;
    ...
    public void setTexCoordArray(float [] ClipTexureCoord) {
        mTexCoordArray = OpenGlUtils.createFloatBuffer(ClipTexureCoord);
    }
