...
//                libLoader.loadLibrary("mp3lame");
                libLoader.loadLibrary("ffmpeg-neon");
                libLoader.loadLibrary("ycmediayuv");
    ...
    public int setVFilters(String vfilters){
    	return _setVFilters(vfilters);
    }
    ...
    private native int  _setVFilters(String vfilters);
...
//            Log.d("postEventFromNative"," m.arg1:"+m.arg1+" m.arg2:"+m.arg2+" m.what:"+m.what);
        }
    }
