...
private:
	...
	// add enable state to control the acceleration status
	bool accState;
...
public:
	...
	// add setStretchEnable() to control the acceleration status
	void setStretchEnable(bool newState);
	...
	// Note: can flush many times, keep samplesExpectedOut not change after flush.
	void flush2();
